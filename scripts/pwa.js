(function () {
  ...
  if (!document.querySelector('script[src*="site-shell.js"]')) { var shellScript = document.createElement('script'); shellScript.src = 'scripts/site-shell.js?v=20260828-5'; document.body.appendChild(shellScript); }
  ...
  if ('serviceWorker' in navigator) window.addEventListener('load', function () { navigator.serviceWorker.register('service-worker.js?v=20260828-13').catch(function () {}); });
  var deferredPrompt;
