(function () {
  if (!document.querySelector('link[href*="site-shell.css"]')) { var shellStyles = document.createElement('link'); shellStyles.rel = 'stylesheet'; shellStyles.href = 'styles/site-shell.css?v=20260828-3'; document.head.appendChild(shellStyles); }
  if (!document.querySelector('link[href*="mobile.css"]')) { var mobileStyles = document.createElement('link'); mobileStyles.rel = 'stylesheet'; mobileStyles.href = 'styles/mobile.css?v=20260828-2'; document.head.appendChild(mobileStyles); }
  ...
  if ('serviceWorker' in navigator) window.addEventListener('load', function () { navigator.serviceWorker.register('service-worker.js?v=20260828-4').catch(function () {}); });
  var deferredPrompt;
