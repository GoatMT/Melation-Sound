(function () {
  ...
  function init() {
    if (!document.querySelector('link[href*="rooms-host-rail.css"]')) { var hostRailStyles = document.createElement('link'); hostRailStyles.rel = 'stylesheet'; hostRailStyles.href = 'styles/rooms-host-rail.css?v=20260901-3'; document.head.appendChild(hostRailStyles); }
