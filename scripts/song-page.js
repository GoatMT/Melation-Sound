(function(){
  var tracks = {
    '01': { title:'A Dreams A Mystery', type:'Album track', artist:'Osama, MT', release:'A Broken Dream', date:'August 24, 2026', back:'albums/a-broken-dream/index.html', art:'albums/a-broken-dream/assets/album-cover.png', audio:'albums/a-broken-dream/assets/a-dreams-a-mystery.mp3', length:'00:00:20', bitrate:'192kbps', sampleRate:'44.100 kHz', status:'Available now', lyrics:'Lyrics have not been published for this track yet.' },
    '02': { title:'Nightmare Fuel', type:'Album track', artist:'Osama, MT and Adam', release:'A Broken Dream', date:'August 27, 2026', back:'albums/a-broken-dream/index.html', art:'albums/a-broken-dream/assets/Nightmare Fuel.png', audio:'albums/a-broken-dream/assets/Nightmare Fuel.MP3', length:'00:00:37', bitrate:'192kbps', sampleRate:'44.100 kHz', status:'Available now', lyrics:'Lyrics have not been added for this track yet.' },
    '03': { title:'6 Feet Under', type:'Album track', artist:'Osama, MT', release:'A Broken Dream', date:'Not posted', back:'albums/a-broken-dream/index.html', art:'albums/a-broken-dream/assets/album-cover.png', status:'Out Dec 20, 2026', lyrics:'Lyrics will be available when this track is released.' },
    '04': { title:'Fake Smile', type:'Album track', artist:'Osama, MT', release:'A Broken Dream', date:'Not posted', back:'albums/a-broken-dream/index.html', art:'albums/a-broken-dream/assets/album-cover.png', status:'Out Dec 20, 2026', lyrics:'Lyrics will be available when this track is released.' },
    '05': { title:'Ghost in the Mirror', type:'Album track', artist:'Osama, MT', release:'A Broken Dream', date:'Not posted', back:'albums/a-broken-dream/index.html', art:'albums/a-broken-dream/assets/album-cover.png', status:'Out Dec 20, 2026', lyrics:'Lyrics will be available when this track is released.' },
    '06': { title:'No More Tears', type:'Album track', artist:'Osama, MT', release:'A Broken Dream', date:'Not posted', back:'albums/a-broken-dream/index.html', art:'albums/a-broken-dream/assets/album-cover.png', status:'Out Dec 20, 2026', lyrics:'Lyrics will be available when this track is released.' },
    '07': { title:'Static', type:'Album track', artist:'Osama, MT', release:'A Broken Dream', date:'Not posted', back:'albums/a-broken-dream/index.html', art:'albums/a-broken-dream/assets/album-cover.png', status:'Out Dec 20, 2026', lyrics:'Lyrics will be available when this track is released.' },
    '08': { title:'Empty Rooms', type:'Album track', artist:'Osama, MT', release:'A Broken Dream', date:'Not posted', back:'albums/a-broken-dream/index.html', art:'albums/a-broken-dream/assets/album-cover.png', status:'Out Dec 20, 2026', lyrics:'Lyrics will be available when this track is released.' },
...
10-20` }
  ...
  if(track.gateEnabled && !hasPrivateAccess()){document.body.classList.add('private-song-locked');$('privateGate').hidden=false;}
  if(!track.gateEnabled || hasPrivateAccess()) startEngagement();
