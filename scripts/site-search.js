(function () {
  ...
  var catalog = [
    ...
    { title: 'Location Unknown', meta: 'Upcoming album · MT · 4 tracks announced', action: 'Open album', href: 'albums/location-unknown/index.html', terms: 'location unknown upcoming album mt cream soda crush my people sources already gone next release' },
